...
class V0AnalyzerHistoInJet : public edm::EDAnalyzer {
public:
  explicit V0AnalyzerHistoInJet(const edm::ParameterSet&);
  ~V0AnalyzerHistoInJet();
...
private:
  ...
  TH1D* InvMass_ks_0_underlying[10];
  TH1D* InvMass_la_0_underlying[10];

  TH1D* InvMass_ks_1_underlying[10];
  TH1D* InvMass_la_1_underlying[10];
  
  TH1D* InvMass_ks_2_underlying[10];
  TH1D* InvMass_la_2_underlying[10];
  
  TH1D* InvMass_ks_3_underlying[10];
  TH1D* InvMass_la_3_underlying[10];
...
V0AnalyzerHistoInJet::V0AnalyzerHistoInJet(const edm::ParameterSet& iConfig)
...
V0AnalyzerHistoInJet::~V0AnalyzerHistoInJet()
{
...
void
V0AnalyzerHistoInJet::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
...
void 
V0AnalyzerHistoInJet::endJob() {
}

//define this as a plug-in
DEFINE_FWK_MODULE(V0AnalyzerHistoInJet);