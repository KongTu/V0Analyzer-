...
// Class:      V0Analyzer
// 
/**\class V0Analyzer V0Analyzer.cc V0Analyzer/V0Analyzer/src/V0AnalyzerNtuple.cc
...
class V0AnalyzerNtuple : public edm::EDAnalyzer {
   public:
      explicit V0AnalyzerNtuple(const edm::ParameterSet&);
      ~V0AnalyzerNtuple();
...
V0AnalyzerNtuple::V0AnalyzerNtuple(const edm::ParameterSet& iConfig)
...
V0AnalyzerNtuple::~V0AnalyzerNtuple()
{
...
void
V0AnalyzerNtuple::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void 
V0AnalyzerNtuple::GenJet(const edm::Event& iEvent, const edm::EventSetup& iSetup){
...
void 
V0AnalyzerNtuple::Calo_Jet(const edm::Event& iEvent, const edm::EventSetup& iSetup){
...
void
V0AnalyzerNtuple::GenParticle(const edm::Event& iEvent, const edm::EventSetup& iSetup){
...
void 
V0AnalyzerNtuple::GeneralTracks(const edm::Event& iEvent, const edm::EventSetup& iSetup){
...
void 
V0AnalyzerNtuple::PF_Jet(const edm::Event& iEvent, const edm::EventSetup& iSetup){
...
void 
V0AnalyzerNtuple::OfflinePrimaryVertex(const edm::Event& iEvent){
...
void
V0AnalyzerNtuple::V0_Kshort(const edm::Event& iEvent){
...
void 
V0AnalyzerNtuple::V0_Lambda(const edm::Event& iEvent){
...
void
V0AnalyzerNtuple::fillVertices(const edm::Event& iEvent){
...
void 
V0AnalyzerNtuple::endJob() 
{
}

// ------------ method called when starting to processes a run  ------------
void 
V0AnalyzerNtuple::beginRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a run  ------------
void 
V0AnalyzerNtuple::endRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
void 
V0AnalyzerNtuple::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
void 
V0AnalyzerNtuple::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
V0AnalyzerNtuple::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(V0AnalyzerNtuple);
